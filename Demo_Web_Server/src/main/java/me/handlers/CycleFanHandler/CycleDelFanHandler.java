...
public class CycleDelFanHandler extends AbstractRequestHandler<CycleFanEditPayload> {//删除关注

    private Model model;

    public CycleDelFanHandler(Model model) {
    ...
    protected Answer processImpl(CycleFanEditPayload value, Map<String, String> urlParams, boolean shouldReturnHtml) {
        ...
        model.CycleDelLike(value.getCycleUserID(),value.getCycleLikeID());
